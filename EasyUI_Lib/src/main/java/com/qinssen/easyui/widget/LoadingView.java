package com.qinssen.easyui.widget;
...
public class LoadingView extends FrameLayout {
    ...
    protected void onFinishInflate() {
        ...
        mRxShapeView = (ImageView) view.findViewById(R.id.shapeLoadingView);
    ...
    public void upThrow() {
        ...
        ObjectAnimator objectAnimator1 = ObjectAnimator.ofFloat(mRxShapeView, "rotation", 0, 0);
