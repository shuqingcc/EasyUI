package com.qinssen.easyui.widget.banner;
...
import com.qinssen.easyui.widget.banner.holder.HolderCreator;
import com.qinssen.easyui.widget.banner.holder.ViewHolder;
import com.qinssen.easyui.widget.banner.transformer.CoverModeTransformer;
import com.qinssen.easyui.widget.banner.transformer.ScaleYTransformer;
...
//    /**
//     * 开始轮播
//     * <p>应该确保在调用用了{@link MZBannerView {@link #setPages(List, HolderCreator)}} 之后调用这个方法开始轮播</p>
//     */
    public void start(){
     ...
     * @param holderCreator  ViewHolder生成器 {@link HolderCreator} And {@link ViewHolder}
     */
