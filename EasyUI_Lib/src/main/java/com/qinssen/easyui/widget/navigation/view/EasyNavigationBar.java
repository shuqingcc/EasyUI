package com.qinssen.easyui.widget.navigation.view;
...
import com.qinssen.easyui.widget.navigation.adapter.ViewPagerAdapter;
import com.qinssen.easyui.widget.navigation.constant.Anim;
import com.qinssen.easyui.utils.NavigationUtil;
 ...
 *                 .fragmentList(fragmentList)       //必传  fragment集合
 *                 .fragmentManager(getSupportFragmentManager())     //必传
 *                 .iconSize(20)     //Tab图标大小
 *                 .tabTextSize(10)   //Tab文字大小
 *                 .tabTextTop(2)     //Tab文字距Tab图标的距离
 *                 .normalTextColor(Color.parseColor("#000000"))   //Tab未选中时字体颜色
 *                 .selectTextColor(Color.parseColor("#FB5959"))   //Tab选中时字体颜色
